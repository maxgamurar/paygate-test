...
use Mockery as m;
use PayGate\Common\Message\AbstractRequest;
...
class AbstractGatewayTest extends TestCase
{
    ...
    {
        $this->gateway = m::mock('\PayGate\Common\AbstractGateway')->makePartial();
    ...
    public function testCreateRequest()
    {
        ...
        $request = $this->gateway->callCreateRequest(
            '\PayGate\Common\AbstractGatewayTest_MockAbstractRequest',
            array('currency' => 'THB')
        );
