...
class HelperTest extends TestCase
{
    ...
    {
        $target = m::mock('\PayGate\Common\CreditCard');
    ...
    {
        $shortName = Helper::getGatewayShortName('PayGate\\Stripe\\Gateway');
    ...
    {
        $shortName = Helper::getGatewayShortName('PayGate\\PayPal\\ExpressGateway');
