...
class AbstractResponseTest extends TestCase
{
    ...
    {
        $this->response = m::mock('\PayGate\Common\Message\AbstractResponse')->makePartial();
    }
    ...
    public function testConstruct()
    {
        ...
        $this->response = m::mock('\PayGate\Common\Message\AbstractResponse', array($request, $data))->makePartial();
    ...
    {
        $this->response = m::mock('\PayGate\Common\Message\AbstractResponseTest_MockRedirectResponse')->makePartial();
