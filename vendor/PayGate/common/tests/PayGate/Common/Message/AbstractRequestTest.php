...
class AbstractRequestTest extends TestCase
{
    ...
    {
        $this->request = m::mock('\PayGate\Common\Message\AbstractRequest')->makePartial();
    ...
    public function testSetCardWithArray()
    {
        ...
        $this->assertInstanceOf('\PayGate\Common\CreditCard', $card);
    ...
    /**
     * @expectedException PayGate\Common\Exception\InvalidRequestException
     */
    ...
    {
        $response = m::mock('\PayGate\Common\Message\ResponseInterface');
    ...
    public function testGetResponseAfterRequestSent()
    {
        ...
        $this->assertInstanceOf('\PayGate\Common\Message\ResponseInterface', $response);
    }
}
...
class AbstractRequestTest_MockAbstractRequest extends AbstractRequest
{
    ...
    {
        $this->response = m::mock('\PayGate\Common\Message\AbstractResponse');
    }
}
